...
frappe.ui.form.on('Cheese Route', {
...
function hide_name_field(frm) {
	...
	setTimeout(function() {
		...
		// Method 3: Hide by label text (Route Name)
		frm.$wrapper.find('label:contains("Route Name"), label:contains("Nombre de la Ruta")').closest('.form-group, .frappe-control').hide();
