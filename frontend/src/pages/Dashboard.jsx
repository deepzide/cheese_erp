...
export default function Dashboard() {
    ...
    const leadsInPeriod = Object.values(dashboard.leads || {}).reduce((sum, n) => sum + (Number(n) || 0), 0);
    const totalLeads = dashboard.total_leads ?? convRates.total_leads ?? leadsInPeriod ?? 0;
